Map<String, String> ru = {
  ...
  'app_name_sub': 'Расчет',
  'right_quadrilateral': 'Прямоугольный',
  'trapezoid_quadrilateral': 'Разносторонний',
  'isosceles_quadrilateral': 'Равнобедренный',
  'equilateral_quadrilateral': 'Равносторонний',
  'right_info': 'Имеет прямой угол (90°)',
  'trapezoid_info': 'Нет равных сторон\nНет равных углов',
  ...
  'catheti': 'катет',
  'h_height_quadrilateral': 'h - высота треугольника',
  'sides_quadrilateral': 'сторона треугольника',
  'base_quadrilateral': 'база треугольника',
  'base': 'база',
  'angle': 'угол',
